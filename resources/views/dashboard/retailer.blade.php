...
@endif
@if (session('already'))
    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" id="myAlert">
        <span class="block sm:inline">{{ session('already') }}</span>
        <span class="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer" data-dismiss="alert">
