            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    ...
                    <div class="px-4 py-3" role="none">
                     ...
                     <!--i have left this as a space for the name of the particular user{$name}} -->
                        </p>
                        <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
<!--i am going to change this line to hold the role that the user plays in the company-->
        ...
        <aside id="logo-sidebar" class=" top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="{{ uri('/redirect') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
